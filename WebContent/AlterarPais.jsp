                    ...
                    <form action="ManterPais.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="pop">Populacao</label>
                                <input type="text" class="form-control" name="pop" id="pop" maxlength="15"  value="${pais.populacao }">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="area">Area</label>
                                <input type="text" class="form-control" name="area" id="area" required maxlength="60"  value="${pais.area }">
                            </div>
                        </div>
                        <hr />
